...
function init() {
    ...
    addRoom("lobby");
    changeRoom("lobby");
    addMessage("lobby", "", "Welcome to the main lobby. You can make new rooms or send a message. Enjoy!", true);
    ...
    newMessageForm.addEventListener("submit", (e) => {
        ...
        const username = usernameField.value || "guest";    // need to get this from a session value
    ...
    newRoomForm.addEventListener("submit", (e) => {
        ...
        addMessage(room, "User", `created a new room "${room}".`, true);
    })
